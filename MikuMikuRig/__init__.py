...
bl_info = {
    ...
    "blender": (5, 0, 0),  # 需要的*最低* blender 版本
...
class MMR_property(bpy.types.PropertyGroup):
    ...
    mass_multiply_rate: FloatProperty(
        default=12.5, description="刚体质量倍率", min=0)
...
class MikuMikuRig_1(Mmr_Panel_Base):
    ...
    def draw(self, context):
        ...
        layout.prop(mmr_property, 'wrist_rotation_follow',
                    text="Wrist rotation follow arm")
...
class MikuMikuRig_2(Mmr_Panel_Base):
    ...
    def draw(self, context):
        ...
        layout.operator("mmr.rigid_body_mass_multiply",
                        text="Rigid Body Mass Multiply")
...
class MikuMikuRig_3(Mmr_Panel_Base):
    ...
    def draw(self, context):
        ...
        layout.prop(mmr_property, 'auto_action_scale',
                    text="Auto mixamo animation scale", toggle=True)
        layout.prop(mmr_property, 'lock_location',
                    text="Lock mixamo animation location", toggle=True)
        row = layout.row()
        ...
        layout.operator("mmr.import_mixamo",
                        text="Import mixamo animation as NLA")
...
class MikuMikuRig_4(Mmr_Panel_Base):
    ...
    def draw(self, context):
        ...
        layout.operator("mmr.convert_rigid_body_to_cloth",
                        text="Convert rigid body to cloth")
        ...
        layout.prop(mmr_property, 'auto_select_mesh',
                    text="Auto select mesh", toggle=True)
        layout.prop(mmr_property, 'auto_select_rigid_body',
